...
classes = [
    ...
    operators.EXPORT_OT_bigworld_selected,   # ✅ 新增
    ...
    panels.BIGWORLD_PT_batch_export,         # ✅ 新增
]
...
def register():
    ...
    bpy.types.Scene.bigworld_export_status = bpy.props.StringProperty(  # ✅ 新增
        name="Export Status",
        description="显示导出状态",
        default="Ready 就绪"
    )
...
def unregister():
    ...
    del bpy.types.Scene.bigworld_export_status   # ✅ 新增
